 ...
 * reuse of a particular Orika mapping configuration in a given context.<br>
 * <br>
 * 
 ...
 * retrieve from MapperFactory. <br>
 * <br>
 * 
 * ConfigurableMapper should be extended, overriding the
 * {@link #configure(MapperFactory)} method to provide the necessary
 * initializations and customizations desired.<br>
 * <br>
 * 
 * Additionally, if customizations are needed to the DefaultMapperFactory
 * builder (used by ConfigurableMapper), the
 * {@link #configureFactoryBuilder(ma.glasnost.orika.impl.DefaultMapperFactory.Builder)}
 * method may be overridden to apply custom parameters to the builder used to
 * obtain the MapperFactory.<br>
 * <br>
 * For example:
 * 
 * <pre>
...
public class ConfigurableMapper implements MapperFacade {
     ...
     * 
     * @param factory
     *            the MapperFactory instance which may be used to register
     ...
     *            the builder which will be used to obtain a MapperFactory
     *            instance
     */
